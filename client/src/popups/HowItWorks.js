        ...
        <div className="popup-wrapper">
            <div className="popup-content" id="how-it-works-content">
                ...
                <div className="popup-block">
                    <p>
                        for each plaintext letter <i>c</i>, the encryption 
                        process
                    </p>
                    <ol>
                        <li>
                        ...
                        <li>
                            maps the resulting new letter through the reflector 
                            to obtain yet another new letter
                        </li>
                        <li>
                        ...
                        <li>
                            and finally, maps that letter through the plugboard 
                            to obtain an encrypted letter <i>c'</i>
                        </li>
                    </ol>
                    <p>
                        ...
                        encrypting <i>c</i> is done and the machine moves on to 
                        the next letter in the message.
                    </p>
                    <p>
                        ...
                        possible rotor offset combinations and if someone wanted
                        to decipher your message without knowing the offsets you
                        used they would have to try each combination.
                    </p>
                    <p>
                        for more information on the enigma machine, check out 
                        this page <a href="https://brilliant.org/wiki/enigma-machine/#:~:text=An%20Enigma%20machine%20is%20a,time%20the%20code%20seemed%20unbreakable." 
